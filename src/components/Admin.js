    ...
    return (
        ...
        <div className="kozep adminbackg">
            <h1 className="h1error adminhead">Adminisztrátori felület</h1>
                <div className="row">
                    <div className="col-3">
                        <button type="button" class="btn btn-success"><a href="/">Termékek kezelése</a> </button>
                    </div>
                    <div className="col-3">
                        <button type="button" class="btn btn-success"><a href="/">Felhsználók kezelése</a> </button>
                    </div>
                    <div className="col-3">
                        <button type="button" class="btn btn-success"><a href="/">Számlázási adatok</a> </button>
                    </div>
                    <div className="col-3">
                        <button type="button" class="btn btn-success"><a href="/">Beszállítók</a> </button>
                    </div>
