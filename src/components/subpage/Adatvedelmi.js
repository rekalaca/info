...
export default function Adatvedelmi() {
    ...
    return (
        ...
        <>
            ...
            <h1 className="adatcim">ADATKEZELÉSI TÁJÉKOZTATÓ</h1>
            <br></br><br></br>
            ...
            <p className="adatkez">
                ...
                Amennyiben megkeresné Társaságunkat, info@infotech.com és +36-30-123-45-67 elérhetőségeken léphet kapcsolatba az adatkezelővel.
                ...
                <br></br><br></br>
                <p className="vastag">Név: Info-Tech kft
                <br></br>
                Székhely: 4400 Nyíregyháza Info utca 1.
                <br></br>
                Cégjegyzékszám: 01-10-031828
                <br></br>
                A bejegyző bíróság megnevezése: Nem ismert
                <br></br>
                Adószám: 12345678-9-10
                <br></br>
                Telefonszám: +36-30-123-45-67
                <br></br>
                E-mail: info@infotech.com
                <br></br>
                Adatvédelmi tisztviselő
                <br></br>
                Név: Adatkezelő Gyula
                <br></br>
                Telefonszám: +36-30-987-65-43
                <br></br>
                <br></br>
                </p>
                A kezelt személyes adatok köre: Név, születési idő, lakcím...
                <br></br>
                Regisztrációs során megadandó személyes adatok: Felhasználónév, jelszó, név, születési dátum, email cím, telefonszám, adószám, számlázási cín, szállítási cím.
                <br></br>
                ...
                Az Adatkezelő olyan műszaki, szervezési és szervezeti intézkedésekkel gondoskodik az adatkezelés biztonságának védelméről, 
                ...
                A működéshez szigorúan szükséges cookie-k: Ezek a cookie-k a weboldal használatához nélkülözhetetlenek, és lehetővé teszik a 
                weboldal alapvető funkcióinak használatát. Ezek hiányába az oldal számos funkciója nem lesz elérhető az Ön számára. Ezen 
                típusú cookie-k élettartama kizárólag a munkamenet idejére korlátozódik.<br></br>
                A felhasználói élmény javítását szolgáló cookie-k: Ezek a cookie-k információkat gyűjtenek a felhasználó weboldalhasználatáról, 
                például, hogy mely oldalakat látogatja leggyakrabban, vagy milyen hibaüzenetet kap a weboldalról. Ezek a cookie-k nem gyűjtenek a 
                látogatót azonosító információkat, vagyis teljesen általános, névtelen információkkal dolgoznak. Az ezekből nyert adatokat a 
                weboldal teljesítményének javítására használjuk. Ezen típusú cookie-k élettartama kizárólag a munkamenet idejére korlátozódik.<br></br>
                <br></br>Harmadik fél által elhelyezett cookie-k (analitika):<br></br>
                Google Adwords cookie Amikor valaki meglátogatja az oldalunkat, a látogató cookie-azonosítója hozzáadódik a remarketinglistához.
                ...
                hirdetők hirdetéseivel vagy a keresési eredményekkel való korábbi interakcióit, továbbá a hirdetők webhelyein tett látogatásait. 
                Az AdWords konverziókövetés funkciója cookie-kat használ. A hirdetésből eredő értékesítések és egyéb konverziók követésére cookie-kat 
                ment a felhasználó számítógépére, amikor az adott személy egy hirdetésre kattint. A cookie-k néhány gyakori alkalmazási módja: 
                a hirdetések kiválasztása annak alapján, hogy mi a releváns az adott felhasználó esetén, a kampányok teljesítményéről szóló jelentések 
                tökéletesítése, és a felhasználó által már megtekintett hirdetések megjelenítésének elkerülése.<br></br>
                Google Analytics cookie: A Google Analytics a Google elemző eszköze, amely abban segít a weboldalak és alkalmazások tulajdonosainak, 
                hogy pontosabb képet kapjanak látogatóik tevékenységeiről. A szolgáltatás cookie-kat használhat, hogy információkat gyűjtsön és 
                jelentést készítsen a weboldal használatára vonatkozó statisztikai adatokból anélkül, hogy egyénileg azonosítaná a látogatókat a 
                Google számára. A Google Analytics által használt fő cookie a „__ga” cookie. A webhelyhasználati statisztikai adatokból készülő 
                jelentések mellett a Google Analytics – az előbbiekben ismertetett néhány hirdetési cookie-val együtt – felhasználható arra is, 
                hogy relevánsabb hirdetéseket jelenítsünk meg a Google-termékekben (például a Google Keresésben) és szerte az interneten.<br></br>
                Remarketing cookiek-k: A korábbi látogatók vagy felhasználók számára a Google Display Hálózaton található egyéb webhelyeken való 
                böngészés, illetve termékeivel vagy szolgáltatásaival kapcsolatos kifejezések keresésekor jelenhetnek meg.<br></br>
                Munkamenet cookie: Ezek a sütik a látogató tartózkodási helyét, a böngésző nyelvét, a fizetés pénznemét tárolják, élettartamuk a 
